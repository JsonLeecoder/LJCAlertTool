...
- (void)showHudInView:(UIView *)view hint:(NSString *)hint{
    ...
    UIImageView *imageView = [[UIImageView alloc] initWithImage:[UIImage sd_animatedGIFNamed:@"timg"]];
...
//    gifview.image=image;
//    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:self.view animated:YES];    hud.color=[UIColor grayColor];//默认颜色太深了
//    hud.mode = MBProgressHUDModeCustomView;
//    hud.labelText = @"加载中...";
